...
final questionNotifierProvider =
    StateNotifierProvider.family<QuestionNotifier, bool, QuestionServiceArgs>(
        (ref, qargs) {
...
final questionsProvider =
    FutureProvider.family<List<QuestionModel>, QuestionServiceArgs>(
        (ref, args) async {
