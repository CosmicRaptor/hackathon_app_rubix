...
final questionServiceProvider =
    Provider.family<QuestionService, QuestionServiceArgs>((ref, args) {
  final firebaseStorage = FirebaseFirestore.instance;
  return QuestionService(
      firebaseStorage: firebaseStorage, level: args.level, era: args.era);
});
...
class QuestionService {
  ...
  QuestionService({
    ...
    questionsCollection = firebaseStorage
        .collection('Quiz')
        .doc(era)
        .collection('levels')
        .doc(level.toString())
